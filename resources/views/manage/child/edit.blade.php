...
@section('content')
    ...
    <b-tabs v-model="activeTab" position="is-centered" expanded class="block">
        ...
        <b-tab-item label="Sources">
            <manage-child-sources-item childid="{{ $child->id }}"></manage-child-sources-item>
            <a href="{{ route('manage.content.source.create', ['child' => $child->id]) }}" class="button is-primary is-outlined is-fullwidth m-t-5">Add New Source</a>
        </b-tab-item>
